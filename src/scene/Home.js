  ...
  saveTransport = () => {
    ...
    if (this.state.select != null) {
      ...
      this
        ...
        .doc
        .ref
        .update({time: this.state.time, direction: this.state.city, transport});
    }
    ...
    PushNotification.localNotificationSchedule({
      ...
      bigText: "Go to "+transport+" to "+this.state.city+" .", // (optional) default: "message" prop
      ...
      message: this.state.city+" "+this.state.time+" "+transport, // (required)
