  ...
  toggleComplete() {
    ...
    if (!this.props.active) {
      PushNotification.localNotificationSchedule({
        id: this.props.id, autoCancel: false, color: "#2196F3", // (optional) default: system default
        title: "Transport Notification", // (optional)
        message: this.props.direction + " " + Moment(this.props.time).format("HH:mm") + " " + this.props.transport, // (required) // (optional) Sound to play when the notification is shown. Value of 'default' plays the default sound. It can be set to a custom sound such as 'android.resource://com.xyz/raw/my_sound'. It will look for the 'my_sound' audio file in 'res/raw' directory and play it. default: 'default' (default sound is played)
